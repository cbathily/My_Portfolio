    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Already strongly associated with second-hand shopping. However, the visual identity felt generic and interchangeable, with little emotional or cultural depth.',
          'The brief encouraged experimentation, so we explored a focused approach.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Early on, we aligned on a clear retro direction. We explored references from vintage electronics, arcade games, and early digital interfaces, which led to a warm and saturated colour palette that shaped the entire design system.',
          'From there, the concept developed organically through iteration and discussion. Each team member contributed to different aspects of the system, including branding, UI, and interaction ideas, which were refined together rather than separately.',
          'Key outcomes of the process included:',
        ],
        issues: [
          { title: 'Brand identity exploration', desc: 'Development of a retro-inspired logo system and a playful mascot that represents the platform.' },
          { title: 'Visual language', desc: 'A consistent design style inspired by early gaming interfaces, arcade aesthetics, and nostalgic UI patterns.' },
